...
**All absolute-date deadline copy lost `at` on 2026-08-21.** The remaining
future-date branch now renders `Complete it by 23 Aug 2026 4:30 PM`; no other
date or time formatting changed. This is generated by the same shared formatter
and passed as the complete `{{5}}` value to all six corporate generic, AI
Interview, and Mix & Match invite/reminder templates, as well as to email. The
